...
public class Magic extends Terran{  //클래스에는 public or default만 존재함.
...
//	public Magic() { //컴파일러가 넣어주는 기본 생성자가 어떤 역할를 하는지 코드로 정의
...
//	}
//	
//	public Magic(String name, String rank) {
//
//		/*
...
//	}
	...
	public Magic(String name, String rank, int hp, int damage) {
		super("테란");
		this.name	=	name;
		this.rank	=	rank;
		this.hp		=	hp;
...
//		return	"이름은 " + this.name + " 계급은 " + this.rank + " HP :" + this.hp + " damage : " + this.damage;
//	}
