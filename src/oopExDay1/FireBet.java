...
public class FireBet extends Terran implements Attackable {  //클래스에는 public or default만 존재함.
...
//	public FireBet() { //컴파일러가 넣어주는 기본 생성자가 어떤 역할를 하는지 코드로 정의
...
//	}
	...
	public void sound() {
		System.out.println("파이어 사운드");
	}

	@Override
	public void attack(String taget) {
		// TODO Auto-generated method stub
		System.out.println(super.getTheUnit() + "이불을 뿜으며 " + taget + " 을 공격합니다.");
	}
}
